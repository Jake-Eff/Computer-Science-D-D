...
public class DynamicProgramming {
    ...
    public static int hiLoHelper(int[] lowPayouts, int[] highPayouts, HashMap<Integer, Integer> expectedPay, int day){
        ...
        int highPayout = highPayouts[day] + hiLoHelper(lowPayouts, highPayouts, expectedPay, day + 2);
